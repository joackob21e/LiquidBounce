    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        if (!moduleValues.isEmpty()) {
            ...
            if (moduleElement.isShowSettings()) {
                if (moduleElement.getSettingsWidth() > 0F && moduleElement.settingHeight > moduleElement.getY() + 6) {
                    RenderUtils.drawBorderedRect(moduleElement.getX() + moduleElement.getWidth() + 4, moduleElement.getY() + 6, moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth(), moduleElement.settingHeight + 2, 3F, new Color(54, 71, 96).getRGB(), new Color(54, 71, 96).getRGB());
                }

                moduleElement.settingHeight = moduleElement.getY() + 6;

                int count = 0;
                for (final Value value : moduleValues) {
                    if(++count > moduleElement.settingScrollIndex && count < moduleElement.settingScrollIndex + 15 && moduleElement.settingScrollIndex < moduleValues.size()) {
                        drawSetting(moduleElement, value, mouseX, mouseY);
                    }
                }

                // Scrollbar
                if(moduleValues.size() > 15) {
/*                    RenderUtils.drawRect(
                            moduleElement.getX() + moduleElement.getWidth() + 2,
                            moduleElement.getY() + 6,
                            moduleElement.getX() + moduleElement.getWidth() + 4,
                            moduleElement.settingHeight,
                            new Color(54, 71, 96).getRGB()
                    );

                    // Make scrollbar
                    final float scrollHeight = (moduleElement.settingHeight - moduleElement.getY()) / (moduleValues.size() / 15 - moduleElement.settingScrollIndex);
                    System.out.println(scrollHeight + " " + moduleElement.settingScrollIndex);
                    RenderUtils.drawRect(
                            moduleElement.getX() + moduleElement.getWidth() + 2,
                            (moduleElement.getY() + 6) + scrollHeight - 10.0f,
                            moduleElement.getX() + moduleElement.getWidth() + 4,
                            (moduleElement.getY() + 6) + scrollHeight,
                            new Color(7, 152, 252).getRGB()
                    );*/
                }
    ...
    private void drawSetting(final ModuleElement moduleElement, final Value value, final int mouseX, final int mouseY) {
        ...
        if (value instanceof BoolValue) {
            ...
            if (mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= moduleElement.settingHeight && mouseY <= moduleElement.settingHeight + 12 && Mouse.isButtonDown(0) && moduleElement.isntPressed()) {
            ...
            Fonts.font35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.settingHeight + 2, ((BoolValue) value).get() ? Color.WHITE.getRGB() : Integer.MAX_VALUE);
            moduleElement.settingHeight += 11;
            ...
            Fonts.font35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.settingHeight + 2, 0xffffff);
            Fonts.font35.drawString(listValue.openList ? "-" : "+", (int) (moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() - (listValue.openList ? 5 : 6)), moduleElement.settingHeight + 2, 0xffffff);

            if (mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= moduleElement.settingHeight && mouseY <= moduleElement.settingHeight + Fonts.font35.getFontHeight() && Mouse.isButtonDown(0) && moduleElement.isntPressed()) {
                listValue.openList = !listValue.openList;
                mc.getSoundHandler().playSound(PositionedSoundRecord.create(new ResourceLocation("gui.button.press"), 1.0F));
            }

            moduleElement.settingHeight += Fonts.font35.getFontHeight() + 1;
            ...
            for (final String valueOfList : listValue.getValues()) {
                ...
                if (listValue.openList) {
                    if (mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= moduleElement.settingHeight + 2 && mouseY <= moduleElement.settingHeight + 14 && Mouse.isButtonDown(0) && moduleElement.isntPressed()) {
                        listValue.set(valueOfList);
                        mc.getSoundHandler().playSound(PositionedSoundRecord.create(new ResourceLocation("gui.button.press"), 1.0F));
                    }

                    GlStateManager.resetColor();
                    Fonts.font35.drawString("> " + valueOfList, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.settingHeight + 2, listValue.get() != null && listValue.get().equalsIgnoreCase(valueOfList) ? Color.WHITE.getRGB() : Integer.MAX_VALUE);
                    moduleElement.settingHeight += Fonts.font35.getFontHeight() + 1;
                }
            }

            if (!listValue.openList) {
                moduleElement.settingHeight += 1;
            }
            ...
            final float valueOfSlide = drawSlider(floatValue.get(), floatValue.getMinimum(), floatValue.getMaximum(), moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.settingHeight + 14, (int) moduleElement.getSettingsWidth() - 12, mouseX, mouseY, new Color(7, 152, 252));

            if (valueOfSlide != floatValue.get())
                floatValue.set(valueOfSlide);

            Fonts.font35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.settingHeight + 3, 0xffffff);
            moduleElement.settingHeight += 19;
            ...
            final float valueOfSlide = drawSlider(integerValue.get(), integerValue.getMinimum(), integerValue.getMaximum(), moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.settingHeight + 14, (int) moduleElement.getSettingsWidth() - 12, mouseX, mouseY, new Color(7, 152, 252));
            ...
            Fonts.font35.drawString(displayString, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.settingHeight + 2, Color.WHITE.getRGB());
            ...
            if ((Mouse.isButtonDown(0) && !mouseDown || Mouse.isButtonDown(1) && !rightMouseDown) && mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= moduleElement.settingHeight && mouseY <= moduleElement.settingHeight + 12) {
            ...
            GlStateManager.resetColor();
            Fonts.font35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.settingHeight + 4, 0xffffff);
            moduleElement.settingHeight += 12;
        }
